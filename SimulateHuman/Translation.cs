...
namespace SimulateHuman
{
  ...
  {
    public static readonly Dictionary<string, string> LanguageDicoEn = new Dictionary<string, string>();
    public static readonly Dictionary<string, string> LanguageDicoFr = new Dictionary<string, string>();
