#define DEBUG
using SimulateHuman.Properties;
using System;
...
namespace SimulateHuman
{
  public partial class FormMain : Form
  {
    ...
    private void ButtonStart_Click(object sender, EventArgs e)
    {
      ...
      listBoxResult.Items.Add(moment.ToLongTimeString());
      int numberOfSeconds = HelperClasses.GenerateRndNumberUsingCrypto(1, 59);
      ...
      for (int i = 0; i < 10; i++)
      {
        ...
        numberOfMinutes = HelperClasses.GenerateRndNumberUsingCrypto(0, 59);
        nextTime = new DateTime(1, 1, 1, 0, numberOfMinutes, numberOfSeconds);
        listBoxResult.Items.Add(nextTime.ToLongTimeString());
        //Thread.Sleep((numberOfMinutes * 1000 * 60) + (numberOfSeconds * 1000));
